...
export const fantasyApi = {
  ...
  bulkTransfer: (body: any) => api.post<{ queueId: string; status: string; totalTeams: number; successCount: number; failedCount: number; errors?: string[]; provider?: string; endpoint?: string }>('/api/fantasy/bulk-transfer', body),
